...
Пример запуска программы: "./QRatorTestTask ../topo.txt"
...
Замечание 5: Код не оптимизирован, архитектура не очень продумана, и стиль кода местами страдает так как это всего лишь тестовое задание и мне лень его делать качественно.
