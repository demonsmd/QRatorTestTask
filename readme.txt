...
=====================================================================================
В программном средстве есть реализации двух разработанных алгоритмов решения задачи:

1) DijkstraBasedAlgotithm в routingеablesыolver
Алгоритм состоит из двух частей:
 ...
 ii)    Для каждой вершины определение соседней вершины куда будет идти трафик и определение всего пути. Сложность алгоритма O(n*log(n)), где n - количество узлов, а m - количество рёбер. Сложность реализации O(n^2)

Итоговая сложность алгоритма равна O(n*log(n) + m*log(n)), а сложность реализации - O(n^2).
Сложность реализации можно уменьшить, если хранить внутреннее представление сети не в виду матрицы, а, например, в хеш-таблице или двоичной куче.


#######################################################################

2) PossibleTopoRoutesBasedAlgorithm в routingеablesыolver

Задача решается путём построения всевозможных различных путей из источника до каждого роутера обходом в глубину. Далее для каждой вершины определяется путь, который запомнит эта вершина. Если существует несколько путей, которые создают коллизию, то происходит развёртка пути и устранение коллизии.

Данный алгоритм имеет большую сложность и его стоит использовать на разряженых топологиях размером не более 15 узлов
